...
response_dict = {} #global dictionary
...
#Body Parser
    ...
    for k,v in response_dict.items(): # print out body response using dictionary from above
        print(f"[{k}] Link {k} --> {v}")
...
# Getting User Input
    ...
    for k,v in response_dict.items(): # execute get request or exit program (depending on number)
